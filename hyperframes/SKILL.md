...
description: >
  ...
  For CLI commands (init, lint, preview, render, transcribe, tts) and Minis rendering
...
source: |
  ...
  Minis adaptation: Merged hyperframes + gsap + hyperframes-registry into a single skill,
  added Minis-specific rendering notes and environment check integration.
...
> ```
> This verifies `minis-browser-use`, `ffmpeg`, and required skills are installed.
